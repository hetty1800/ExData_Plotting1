...
par(mfrow=c(2,2))
plot(P1$Date_Time,P1$Global_active_power,type="l",xlab="",
     ylab="Global Active Power")
plot(P1$Date_Time,P1$Voltage,type="l",xlab="datetime",
     ylab="Voltage")
...
plot(P1$Date_Time, P1$Global_reactive_power, type="l", col="black",
